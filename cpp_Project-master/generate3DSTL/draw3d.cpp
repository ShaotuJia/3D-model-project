    ...
    : m_count(0), vectorSize(1)
{
 ...
 /*
    ...
    print3D (u);
   Cylinder3D w (0,0,0,5,10,M_PI/4,M_PI/4,30); //(center.x,center.y,center.z,radius,height,incline in x-drection,incline in y-direction,accurarcy)
    print3D(w);
    Cylinder3D x(0,0,10,10,0,5,10,M_PI*2,100); //(axis.x,axis.y,center.x,center.y,center.z,radius,height, rotation angle, accuarcy)
    print3D(x);
